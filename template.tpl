...

{
  ...
  "description": "This label template is Magfi's official template for Google Tag Manager. Magfi Pixel allows conversion tracking at both the page and event level in your Magfi Ads.",
  "containerContexts": [
    "WEB"
  ]
}
